...
var file_operations_proto_rawDesc = []byte{
	...
	0x10, 0x03, 0x22, 0x5e, 0x0a, 0x14, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x65, 0x72, 0x67, 0x65, 0x42,
	0x72, 0x61, 0x6e, 0x63, 0x68, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x3d, 0x0a, 0x0c, 0x61, 0x63,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x61, 0x0a, 0x16, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x65, 0x72,
	0x67, 0x65, 0x54, 0x6f, 0x52, 0x65, 0x66, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x11,
	...
	0x4f, 0x4e, 0x46, 0x4c, 0x49, 0x43, 0x54, 0x10, 0x02, 0x22, 0x93, 0x03, 0x0a, 0x11, 0x55, 0x73,
	...
	0x72, 0x65, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xad,
	...
	0x02, 0x20, 0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x05, 0x61, 0x70, 0x70, 0x6c, 0x79, 0x1a, 0x82,
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x1b, 0x0a, 0x09, 0x72, 0x65, 0x62, 0x61, 0x73, 0x65, 0x5f,
	0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x62, 0x61, 0x73, 0x65,
...
var file_operations_proto_goTypes = []interface{}{
	...
	(*GitCommit)(nil),                           // 46: gitaly.GitCommit
}
var file_operations_proto_depIdxs = []int32{
	...
	40, // 18: gitaly.UserMergeToRefRequest.repository:type_name -> gitaly.Repository
	41, // 19: gitaly.UserMergeToRefRequest.user:type_name -> gitaly.User
	43, // 20: gitaly.UserMergeToRefRequest.timestamp:type_name -> google.protobuf.Timestamp
	40, // 21: gitaly.UserFFBranchRequest.repository:type_name -> gitaly.Repository
	41, // 22: gitaly.UserFFBranchRequest.user:type_name -> gitaly.User
	18, // 23: gitaly.UserFFBranchResponse.branch_update:type_name -> gitaly.OperationBranchUpdate
	40, // 24: gitaly.UserCherryPickRequest.repository:type_name -> gitaly.Repository
	41, // 25: gitaly.UserCherryPickRequest.user:type_name -> gitaly.User
	46, // 26: gitaly.UserCherryPickRequest.commit:type_name -> gitaly.GitCommit
	40, // 27: gitaly.UserCherryPickRequest.start_repository:type_name -> gitaly.Repository
	43, // 28: gitaly.UserCherryPickRequest.timestamp:type_name -> google.protobuf.Timestamp
	18, // 29: gitaly.UserCherryPickResponse.branch_update:type_name -> gitaly.OperationBranchUpdate
	0,  // 30: gitaly.UserCherryPickResponse.create_tree_error_code:type_name -> gitaly.UserCherryPickResponse.CreateTreeError
	40, // 31: gitaly.UserRevertRequest.repository:type_name -> gitaly.Repository
	41, // 32: gitaly.UserRevertRequest.user:type_name -> gitaly.User
	46, // 33: gitaly.UserRevertRequest.commit:type_name -> gitaly.GitCommit
	40, // 34: gitaly.UserRevertRequest.start_repository:type_name -> gitaly.Repository
	43, // 35: gitaly.UserRevertRequest.timestamp:type_name -> google.protobuf.Timestamp
	18, // 36: gitaly.UserRevertResponse.branch_update:type_name -> gitaly.OperationBranchUpdate
	1,  // 37: gitaly.UserRevertResponse.create_tree_error_code:type_name -> gitaly.UserRevertResponse.CreateTreeError
	2,  // 38: gitaly.UserCommitFilesActionHeader.action:type_name -> gitaly.UserCommitFilesActionHeader.ActionType
	25, // 39: gitaly.UserCommitFilesAction.header:type_name -> gitaly.UserCommitFilesActionHeader
	40, // 40: gitaly.UserCommitFilesRequestHeader.repository:type_name -> gitaly.Repository
	41, // 41: gitaly.UserCommitFilesRequestHeader.user:type_name -> gitaly.User
	40, // 42: gitaly.UserCommitFilesRequestHeader.start_repository:type_name -> gitaly.Repository
	43, // 43: gitaly.UserCommitFilesRequestHeader.timestamp:type_name -> google.protobuf.Timestamp
	27, // 44: gitaly.UserCommitFilesRequest.header:type_name -> gitaly.UserCommitFilesRequestHeader
	26, // 45: gitaly.UserCommitFilesRequest.action:type_name -> gitaly.UserCommitFilesAction
	18, // 46: gitaly.UserCommitFilesResponse.branch_update:type_name -> gitaly.OperationBranchUpdate
	38, // 47: gitaly.UserRebaseConfirmableRequest.header:type_name -> gitaly.UserRebaseConfirmableRequest.Header
	40, // 48: gitaly.UserSquashRequest.repository:type_name -> gitaly.Repository
	41, // 49: gitaly.UserSquashRequest.user:type_name -> gitaly.User
	41, // 50: gitaly.UserSquashRequest.author:type_name -> gitaly.User
	43, // 51: gitaly.UserSquashRequest.timestamp:type_name -> google.protobuf.Timestamp
	39, // 52: gitaly.UserApplyPatchRequest.header:type_name -> gitaly.UserApplyPatchRequest.Header
	18, // 53: gitaly.UserApplyPatchResponse.branch_update:type_name -> gitaly.OperationBranchUpdate
	40, // 54: gitaly.UserUpdateSubmoduleRequest.repository:type_name -> gitaly.Repository
	41, // 55: gitaly.UserUpdateSubmoduleRequest.user:type_name -> gitaly.User
	43, // 56: gitaly.UserUpdateSubmoduleRequest.timestamp:type_name -> google.protobuf.Timestamp
	18, // 57: gitaly.UserUpdateSubmoduleResponse.branch_update:type_name -> gitaly.OperationBranchUpdate
	40, // 58: gitaly.UserRebaseConfirmableRequest.Header.repository:type_name -> gitaly.Repository
	41, // 59: gitaly.UserRebaseConfirmableRequest.Header.user:type_name -> gitaly.User
	40, // 60: gitaly.UserRebaseConfirmableRequest.Header.remote_repository:type_name -> gitaly.Repository
	43, // 61: gitaly.UserRebaseConfirmableRequest.Header.timestamp:type_name -> google.protobuf.Timestamp
	40, // 62: gitaly.UserApplyPatchRequest.Header.repository:type_name -> gitaly.Repository
	41, // 63: gitaly.UserApplyPatchRequest.Header.user:type_name -> gitaly.User
	43, // 64: gitaly.UserApplyPatchRequest.Header.timestamp:type_name -> google.protobuf.Timestamp
	3,  // 65: gitaly.OperationService.UserCreateBranch:input_type -> gitaly.UserCreateBranchRequest
	5,  // 66: gitaly.OperationService.UserUpdateBranch:input_type -> gitaly.UserUpdateBranchRequest
	7,  // 67: gitaly.OperationService.UserDeleteBranch:input_type -> gitaly.UserDeleteBranchRequest
	11, // 68: gitaly.OperationService.UserCreateTag:input_type -> gitaly.UserCreateTagRequest
	9,  // 69: gitaly.OperationService.UserDeleteTag:input_type -> gitaly.UserDeleteTagRequest
	16, // 70: gitaly.OperationService.UserMergeToRef:input_type -> gitaly.UserMergeToRefRequest
	13, // 71: gitaly.OperationService.UserMergeBranch:input_type -> gitaly.UserMergeBranchRequest
	19, // 72: gitaly.OperationService.UserFFBranch:input_type -> gitaly.UserFFBranchRequest
	21, // 73: gitaly.OperationService.UserCherryPick:input_type -> gitaly.UserCherryPickRequest
	28, // 74: gitaly.OperationService.UserCommitFiles:input_type -> gitaly.UserCommitFilesRequest
	30, // 75: gitaly.OperationService.UserRebaseConfirmable:input_type -> gitaly.UserRebaseConfirmableRequest
	23, // 76: gitaly.OperationService.UserRevert:input_type -> gitaly.UserRevertRequest
	32, // 77: gitaly.OperationService.UserSquash:input_type -> gitaly.UserSquashRequest
	34, // 78: gitaly.OperationService.UserApplyPatch:input_type -> gitaly.UserApplyPatchRequest
	36, // 79: gitaly.OperationService.UserUpdateSubmodule:input_type -> gitaly.UserUpdateSubmoduleRequest
	4,  // 80: gitaly.OperationService.UserCreateBranch:output_type -> gitaly.UserCreateBranchResponse
	6,  // 81: gitaly.OperationService.UserUpdateBranch:output_type -> gitaly.UserUpdateBranchResponse
	8,  // 82: gitaly.OperationService.UserDeleteBranch:output_type -> gitaly.UserDeleteBranchResponse
	12, // 83: gitaly.OperationService.UserCreateTag:output_type -> gitaly.UserCreateTagResponse
	10, // 84: gitaly.OperationService.UserDeleteTag:output_type -> gitaly.UserDeleteTagResponse
	17, // 85: gitaly.OperationService.UserMergeToRef:output_type -> gitaly.UserMergeToRefResponse
	14, // 86: gitaly.OperationService.UserMergeBranch:output_type -> gitaly.UserMergeBranchResponse
	20, // 87: gitaly.OperationService.UserFFBranch:output_type -> gitaly.UserFFBranchResponse
	22, // 88: gitaly.OperationService.UserCherryPick:output_type -> gitaly.UserCherryPickResponse
	29, // 89: gitaly.OperationService.UserCommitFiles:output_type -> gitaly.UserCommitFilesResponse
	31, // 90: gitaly.OperationService.UserRebaseConfirmable:output_type -> gitaly.UserRebaseConfirmableResponse
	24, // 91: gitaly.OperationService.UserRevert:output_type -> gitaly.UserRevertResponse
	33, // 92: gitaly.OperationService.UserSquash:output_type -> gitaly.UserSquashResponse
	35, // 93: gitaly.OperationService.UserApplyPatch:output_type -> gitaly.UserApplyPatchResponse
	37, // 94: gitaly.OperationService.UserUpdateSubmodule:output_type -> gitaly.UserUpdateSubmoduleResponse
