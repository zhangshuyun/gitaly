...
type UserRebaseConfirmableError struct {
	...
	//	*UserRebaseConfirmableError_PreReceive
...
func (x *UserRebaseConfirmableError) GetPreReceive() string {
	if x, ok := x.GetError().(*UserRebaseConfirmableError_PreReceive); ok {
		return x.PreReceive
	}
	return ""
}
...
type UserRebaseConfirmableError_PreReceive struct {
	PreReceive string `protobuf:"bytes,3,opt,name=pre_receive,json=preReceive,proto3,oneof"`
}
...
func (*UserRebaseConfirmableError_PreReceive) isUserRebaseConfirmableError_Error() {}
...
var file_operations_proto_rawDesc = []byte{
	...
	0x22, 0xda, 0x01, 0x0a, 0x1a, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x62, 0x61, 0x73, 0x65, 0x43,
	...
	0x74, 0x12, 0x21, 0x0a, 0x0b, 0x70, 0x72, 0x65, 0x5f, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0a, 0x70, 0x72, 0x65, 0x52, 0x65, 0x63,
	0x65, 0x69, 0x76, 0x65, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xac, 0x01,
	...
	0x69, 0x63, 0x74, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xdd, 0x02, 0x0a,
...
func file_operations_proto_init() {
	...
	file_operations_proto_msgTypes[31].OneofWrappers = []interface{}{
		...
		(*UserRebaseConfirmableError_PreReceive)(nil),
	}
