...
func TestWalker_ExecOnRepositories(t *testing.T) {
	...
	gittest.CloneRepoAtStorage(t, gCfg.Storages[0], repo1RelPath)
	gittest.CloneRepoAtStorage(t, gCfg.Storages[0], repo2RelPath)
	gittest.CloneRepoAtStorage(t, gCfg.Storages[0], repo3RelPath)
