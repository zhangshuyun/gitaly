...
func TestSuccessfulListLastCommitsForTreeRequestWithGlobCharacters(t *testing.T) {
	...
	gittest.Exec(t, cfg, "-C", repoPath, "config", "gittest.TestUser.name", "test@example.com")
	gittest.Exec(t, cfg, "-C", repoPath, "config", "gittest.TestUser.email", "test@example.com")
